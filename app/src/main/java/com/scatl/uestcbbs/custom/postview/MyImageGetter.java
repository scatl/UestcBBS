...
import com.scatl.uestcbbs.custom.glide.GlideUrlDrawable;
...
//            if (resource.getIntrinsicHeight() > 80) {  //表情有可能过大（表情宽高大致相同）
//                resource.setBounds(0, 0, resource.getIntrinsicWidth()/2, resource.getIntrinsicHeight()/2);
//                glideUrlDrawable.setBounds(0, 0, resource.getIntrinsicWidth()/2, resource.getIntrinsicHeight()/2);
//            } else {
//                resource.setBounds(0, 0, resource.getIntrinsicWidth()*2, resource.getIntrinsicHeight()*2);
//                glideUrlDrawable.setBounds(0, 0, resource.getIntrinsicWidth()*2, resource.getIntrinsicHeight()*2);
//            }
